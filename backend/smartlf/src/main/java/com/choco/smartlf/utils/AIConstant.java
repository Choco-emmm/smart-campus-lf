...
public class AIConstant {
    ...
    public static final String CHAT_CLIENT_SYSTEM_PROMPT =
            """
                    ...
                    2. **跳转链接**：在'操作'列中，必须为每个 itemId 生成固定格式的链接：`[查看详情](/item/detail/{itemId})`。
    ...
    public static final String MULTIMODAL_EXTRACT_PROMPT = """
            ...
            请结合以下【帖子基本信息】、【用户初步描述】以及【上传的图片】，严格按照JSON 格式提取特征。
    ...
    public static final String SEARCH_RESULT_SUFFIX =
            """
                    ...
                    2. 在'操作'列，必须为每一行生成一个链接：[点击跳转](/item/detail/{ID})。
                    3. 保持回答简洁，直接展示表格。""";
    // ================= [AI 检索回复话术] =================
