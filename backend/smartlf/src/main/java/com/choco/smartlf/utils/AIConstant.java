...
public class AIConstant {
    ...
    public static final String CHAT_CLIENT_SYSTEM_PROMPT =
            """
                    ...
                    3. 除了检索功能以外，你没有任何其他的function calling功能，不要擅自说“我可以帮您发布失物招领”这种话
                    ...
                    ### 行为约束与安全
                    1. **领域限制**：你只处理失物招领、物品找回相关的问题。对于无关问题（如：数学题、写代码、政治等），请幽默且礼貌地拒绝，并引导回平台功能。
    ...
    public static final String MULTIMODAL_EXTRACT_PROMPT = """
            ...
            以下是JSON格式：
            {
              ...
              "aiGeneratedDesc": "结合图片（如果有的话）和上述所有文字信息，生成一段详细的外观描述（50-100字左右）。不要胡编乱造，要根据事实提取显著特征进行补充。比如，如果没有图片的话，坚决不能有“可以看出”、“看上去”之类的词。注意保护隐私，合理推测。"
            }""";
